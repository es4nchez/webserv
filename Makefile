...
SRCS	= srcs/dev.cpp srcs/main.cpp srcs/handleRequest.cpp srcs/parsingRequest.cpp srcs/sendResponse.cpp srcs/errorResponses.cpp srcs/manageSockets.cpp srcs/args.cpp srcs/Webserv.cpp srcs/cgi.cpp srcs/postRequest.cpp
NAME 	= webserv
COMP 	= c++
